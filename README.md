...
There are 2 recommend approches for a tree of components to interact with each other. 

* Using the **component require property** 
* A standard **angular service**. 

In most cases, using one over the other is just a matter of style but there are cases where you are left with only 1 option.
